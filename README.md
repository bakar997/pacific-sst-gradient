...
- [Beginner learning guide](docs/LEARNING_GUIDE.md): explanations, interview questions and exercises.
- [Data sources and references](DATA_SOURCES.md): citations, versions and access details.
- [Upload instructions](docs/GITHUB_UPLOAD.md): publish the extracted repository files.
- [Personal verification](docs/ASSISTANCE.md): how to document your own review of the project.
